         ...
         const toggylestyle=()=>{
            if(mystyle.color==="black"){
                mystyle({
                    ...
                    //broder:"2px sloid white"    
                })
                setBtntext ("Eanble Light mode")
                    }     
                       else{
                    setmystyle({
                        color: "black",
  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body" >
        <strong>This is the first item's accordion body.</strong> It is shown by default, until the collapse plugin adds the appropriate classes that we use to style each element. These classes control the overall appearance, as well as the showing and hiding via CSS transitions. You can modify any of this with custom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within the <code style={mystyle}>.accordion-body</code>, though the transition does limit overflow.
      </div>
    </div>
  </div>
  <div class="accordion-item">
...
<button  onClick={toggylestyle} type="button" className="btn btn-primary">Enable dark mode </button>
    </div>
  )
    }
